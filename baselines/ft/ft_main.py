    ...
    **kwargs: Any,
    ...
    for it in range(hparams.num_steps):
        ...
        if args.weight_based_tracing:
            ...
            star_str = "*"; empty_str = ""            
            print_addendum = ' '.join([f" {tok_idx}{star_str if tok_idx in range(*e_range) else empty_str}: {per_tok_loss:.5f}" for tok_idx, tok_loss in enumerate(per_tok_loss.tolist())])
